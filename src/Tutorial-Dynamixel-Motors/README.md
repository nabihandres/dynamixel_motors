...
check the id and baurate with dyamixel wizard2 open terminal
roslaunch dynamixel_workbench_controllers angular_control.launch open second terminal and check the topics
rostopic list
rostopic pub -r 10 /dynamixel_workbench1/cmd_vel1_WLF geometry_gs/Twist "linear: x: 0.0 y: 0.0 z: 0.0 angular: x: 0.0 y: 0.0 z: 0.0"
remember in linear velocity work in x direction and in angular velocity rotate in z 6) if you want to control you need to subscribe to the topic and send commands in c++ or python
