   ...
   is_loop_(false)
{
  ...
  joint_trajectory_pub_ = node_handle_.advertise<trajectory_msgs::JointTrajectory>("joint_trajectory", 100); // PUBLISH joint_trajectory topic
...
//////////////// get trajectrory info by yaml_file////////////////////////////////////////////////
bool JointOperator::getTrajectoryInfo(const std::string yaml_file, trajectory_msgs::JointTrajectory *jnt_tra_msg) // input the yaml file in the string and the msg inside in the yaml file in *jnt_tra_msg
{
  YAML::Node file;
  file = YAML::LoadFile(yaml_file.c_str());  // load the yaml file
...
/////////////////////////////time_from_start in the yaml file////////////////////////////////////
...
//ros::Publisher joint_trajectory_pub = node_handle.advertise<trajectory_msgs::JointTrajectory>("joint_trajectory", 10);